...
function boot_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'boot_custom_header_args', array(
		...
		'height'                 => 400,
		'flex-height'            => true,
		'wp-head-callback'       => 'boot_header_style',
		'admin-head-callback'    => 'boot_admin_header_style',
		'admin-preview-callback' => 'boot_admin_header_image',
	) ) );

	register_default_headers( array(
		'mountains' => array(
			'url'           => '%s/assets/header.jpg',
			'thumbnail_url' => '',
			'description'   => _x( 'mountain', 'header image description', 'bootheme' ),
		),
		/*'skyline' => array(
...
add_action( 'after_setup_theme', 'boot_custom_header_setup' );

if ( ! function_exists( 'boot_header_style' ) ) :

	function boot_header_style() {
		...
		?>
		<style type="text/css" id="boot-header-css">
			<?php
			...
			.site-header{
				-webkit-box-shadow: 0 0 2px 1px rgba(182,182,182,0.3);
				-moz-box-shadow: 0 0 2px 1px rgba(182,182,182,0.3);
				-o-box-shadow: 0 0 2px 1px rgba(182,182,182,0.3);
				box-shadow: 0 0 2px 1px rgba(182,182,182,0.3);
			}
			<?php else : ?>
			.site-header{
				-webkit-box-shadow: 0 0 1px 1px rgba(182,182,182,0.3);
				-moz-box-shadow: 0 0 1px 1px rgba(182,182,182,0.3);
				-o-box-shadow: 0 0 1px 1px rgba(182,182,182,0.3);
				box-shadow: 0 0 1px 1px rgba(182,182,182,0.3);
			}
			.site-header {
				height: 300px;
			}
...
if ( ! function_exists( 'boot_admin_header_style' ) ) :

	function boot_admin_header_style() {
		?>
		<?php
...
if ( ! function_exists( 'boot_admin_header_image' ) ) :

	function boot_admin_header_image() {
		if ( 'blank' == get_header_textcolor() || '' == get_header_textcolor() ) {
